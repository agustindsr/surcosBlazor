...
namespace SurcosBlazor.Server.Migrations
{
    ...
    [Migration("20200813142606_modificacionesEnTokenGuid")]
    partial class modificacionesEnTokenGuid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.DetalleOrdenProduccion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("detallesOrdenProduccion");
                });
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.EstadoOrdenProduccion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.ImputacionComprobantesCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("imputacionComprobantesCompra");
                });
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.OrdenProduccion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("EstadoOrdenProduccionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EstadoOrdenProduccionId");
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.UserTokenRecovery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.OrdenPago", b =>
                {
                    b.HasBaseType("SurcosBlazor.Shared.Entidades.Comprobante");
                    ...
                    b.Property<int>("ProveedorId")
                        .HasColumnName("OrdenPago_ProveedorId")
                        .HasColumnType("int");
                    ...
                    b.HasDiscriminator().HasValue("OrdenPago");
                });
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.ReciboCobranzas", b =>
                {
                    ...
                    b.Property<int>("EstadoReciboId")
                        .HasColumnName("ReciboCobranzas_EstadoReciboId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.DetalleOrdenProduccion", b =>
                {
                    b.HasOne("SurcosBlazor.Shared.Entidades.OrdenProduccion", "OrdenProduccion")
                        .WithMany("detallesOrdenProduccion")
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.ImputacionComprobantesCompra", b =>
                {
                    b.HasOne("SurcosBlazor.Shared.Entidades.FacturaCompras", "FacturaCompras")
                        .WithMany()
                        .HasForeignKey("FacturaComprasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SurcosBlazor.Shared.Entidades.OrdenPago", "OrdenPago")
            ...
            modelBuilder.Entity("SurcosBlazor.Shared.Entidades.OrdenProduccion", b =>
                {
                    ...
                    b.HasOne("SurcosBlazor.Shared.Entidades.EstadoOrdenProduccion", "EstadoOrdenProduccion")
                        .WithMany()
                        .HasForeignKey("EstadoOrdenProduccionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
